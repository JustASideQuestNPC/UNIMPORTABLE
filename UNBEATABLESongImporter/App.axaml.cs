...
using UNBEATABLESongImporter.Views;

namespace UNBEATABLESongImporter;
...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            (mainWindow as MainWindow).ViewModel = windowContext;
            mainWindow.Closing += (sender, args) => windowContext.OnWindowClosed(sender, args);
        }
